...
public class Framework extends Canvas {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5597595552611675902L;
	/**
     * Width of the frame.
     */
    ...
    public void Draw(Graphics2D g2d)
    {
        switch (gameState)
        {
            ...
            case GAMEOVER:
                ...
                g2d.drawString("The winner is " + Game.winner, frameWidth / 2 - 117, frameHeight / 2);
                g2d.drawString("To exit press ESC", frameWidth / 2 - 117, frameHeight / 2 + 15);
